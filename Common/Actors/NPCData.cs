...
namespace SagaBNS.Common.Actors
{
    ...
    {
        private readonly Dictionary<uint, Skills.Skill> skills = new Dictionary<uint, Skills.Skill>();
        private readonly Dictionary<uint, int> items = new Dictionary<uint, int>();
        private readonly Dictionary<uint, ushort> itemCounts = new Dictionary<uint, ushort>();
        private readonly List<ushort> quests = new List<ushort>();
        private readonly List<NPCDeathSpawn> deathSpawns = new List<NPCDeathSpawn>();
        private byte[] steps = new byte[0];
        public NPCData()
        {
