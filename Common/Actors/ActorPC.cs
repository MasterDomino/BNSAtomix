...
namespace SagaBNS.Common.Actors
{
    ...
    {
        private Job job;
        private ConcurrentDictionary<ushort, Quests.Quest> quests = new ConcurrentDictionary<ushort, Quests.Quest>();
        private List<ushort> locations = new List<ushort>();
        private List<ushort> questsCompleted = new List<ushort>();
        private ConcurrentDictionary<uint, Skill> savedSkills = new ConcurrentDictionary<uint, Skill>();
        ...
        public void AppearenceToSteam(System.IO.Stream stream)
        {
            ...
            stream.Position += 2;
            bw.Write((short)Appearence1.Length);
            bw.Write(Appearence1);
            stream.Position += 2;
            bw.Write((byte)Race);
            bw.Write((short)1);
            ...
            bw.Write((byte)Job);
            bw.Write((short)3);
            bw.Write((short)Appearence2.Length);
            bw.Write(Appearence2);
            bw.Write((short)4);
