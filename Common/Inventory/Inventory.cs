...
namespace SagaBNS.Common.Inventory
{
    ...
    {
        private readonly Dictionary<Containers, FixedCapacityList<Item.Item>> containers = new Dictionary<Containers, FixedCapacityList<Item.Item>>();
        private readonly List<Item.Item> soldItems = new List<Item.Item>();
        ...
        private InventoryEquipSlot GetEquipSlot(Item.Item item)
        {
