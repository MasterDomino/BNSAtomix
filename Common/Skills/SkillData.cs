...
namespace SagaBNS.Common.Skills
{
    ...
    {
        private readonly List<uint> related = new List<uint>();
        private readonly List<uint> previous = new List<uint>();
        private readonly List<int> activationTimes = new List<int>();
