...
namespace SmartEngine.Network.Database.Cache
{
    ...
    public abstract class Cache<KeyType, ValueType>
    {
        ...
        /// 清理老數據的次數
        /// </summary>
        public uint EldestDataClearTimes;
        /// <summary>
        /// 清理老數據的平均時間
        /// </summary>
        ...
        /// Cache請求次數
        /// </summary>
        public ulong CacheRequestTimes;
        /// <summary>
        /// Cache請求命中次數
        /// </summary>
        public ulong CacheRequestHitTimes;
        /// <summary>
        /// 寫入請求次數
        /// </summary>
        ...
        {
            CacheData.TryRemove(key, out CacheDataInfo<KeyType, ValueType> t);
            if (NotifyWriteCache)
            {
                DBWriter.Remove(key);
            }
        ...
        protected void RemoveEldest()
        {
            ...
            {
                if (CacheData.TryRemove(i.Key, out CacheDataInfo<KeyType, ValueType> t) && t != null && t.IsNeedToWrite)
                {
                    DBWriter.Add(ref t);
                }
            }
