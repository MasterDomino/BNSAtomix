...
namespace SmartEngine.Network.Database.Cache
{
    public class WriteCache<KeyType, ValueType>
    {
        ...
        /// DB指令運行方式
        /// </summary>
        protected ICacheDBExecuteType ExecuteType;
        ...
        /// 要求的寫入次數
        /// </summary>
        public ulong RequestTimes;
        /// <summary>
        /// 已執行的寫入次數
        /// </summary>
        public ulong ExecutedRequestTimes;
        /// <summary>
        /// 總重試次數
        /// </summary>
        public ulong TotalRetryTimes;
        /// <summary>
        /// 平均等待時間
        /// </summary>
        ...
        {
            IndexData.TryRemove(key, out CacheDataInfo<KeyType, ValueType> t);
        }
        ...
        public void Flush()
        {
            ...
            {
                if (!CacheData.TryDequeue(out CacheDataInfo<KeyType, ValueType> cData))
                {
                    continue;
                }
            ...
            if (ExecuteType == ICacheDBExecuteType.Sync)
            {
                DBHandler.SaveData(ref data, out IEnumerable<KeyType> success, out IEnumerable<KeyType> fails);
            ...
            if (ExecuteType == ICacheDBExecuteType.Sync)
            {
                DBHandler.DeleteData(ref dataDelete, out IEnumerable<KeyType> success, out IEnumerable<KeyType> fails);
