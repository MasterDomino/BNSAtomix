...
namespace SmartEngine.Network
{
    ...
    public partial class LoggerOld
    {
        ...
        private readonly BitMask<LogContent> logLevel = new BitMask<LogContent>(new BitMask(31));
        ...
        private void WriteLog(string prefix, string p)
        {
            try
            {
                path = GetLogFile();
