...
namespace SmartEngine.Network
{
    ...
    public static class Global
    {
        ...
        {
            return (long)(((ulong)LittleToBigEndian((uint)((ulong)input & 0xFFFFFFFF)) << 32) | LittleToBigEndian((uint)(((ulong)input & 0xFFFFFFFF00000000) >> 32)));
        }

        public static ulong LittleToBigEndian(ulong input)
        {
            return ((ulong)LittleToBigEndian((uint)(input & 0xFFFFFFFF)) << 32) | (ulong)LittleToBigEndian((uint)((input & 0xFFFFFFFF00000000) >> 32));
        }
