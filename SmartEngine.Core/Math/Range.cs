...
namespace SmartEngine.Core.Math
{
    ...
    public unsafe struct Range
    {
        ...
        public string ToString(int precision)
        {
            ...
            return string.Format("{0:0." + str + "} {1:0." + str + "}", minimum, maximum);
        }
        ...
        {
            if (System.Math.Abs(minimum - v.minimum) > epsilon)
            {
                return false;
            }
            if (System.Math.Abs(maximum - v.maximum) > epsilon)
            {
                return false;
            }
            return true;
